      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 space-y-12">
          ...
          <section>
            ...
            <p className="mt-4 text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
              Returns are accepted within 30 days of delivery subject to our
              Returns Policy. Items must be unused and in original packaging.
              Refunds will be processed within 5&ndash;7 business days of
