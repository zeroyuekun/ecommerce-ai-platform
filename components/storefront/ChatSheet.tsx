...
export function ChatSheet() {
  ...
  return (
    <>
      ...
      {/* Chat widget — pops up from bottom-right */}
      <div
        className="fixed z-50 flex flex-col overflow-hidden border border-zinc-200 bg-white shadow-2xl dark:border-zinc-800 dark:bg-zinc-950
          inset-0 sm:inset-auto sm:bottom-24 sm:right-6 sm:h-[600px] sm:w-[400px] sm:rounded-2xl
