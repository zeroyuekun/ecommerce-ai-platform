      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex flex-col items-center justify-center px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/80 sm:text-base">
            Thoughtfully designed furniture that brings warmth and style to
      ...
      <div className="relative w-full min-h-[550px] sm:min-h-[650px] lg:min-h-[780px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="flex flex-col items-center justify-center px-6 text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/80 sm:text-base">
              Timeless silhouettes crafted from premium materials. Discover
              pieces that anchor every room with effortless style.
            </p>
            <div className="mt-6 flex justify-center">
              <Button
                asChild
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        {/* Left: The Rorie Bed */}
        <Link
          href="/shop?category=bedroom&type=beds"
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="flex flex-col items-center justify-center px-6 text-center">
              ...
              <p className="mx-auto mt-3 max-w-sm text-sm leading-relaxed text-white/80">
                Airy silhouettes and natural textures for effortless, everyday
                spaces.
              </p>
              <div className="mt-5 flex justify-center">
                <Button
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="flex flex-col items-center justify-center px-6 text-center">
            ...
            <p className="mx-auto mt-4 max-w-lg text-sm leading-relaxed text-white/80 sm:text-base">
              Warm wood, rich textures, and earthy tones. Embrace the season
