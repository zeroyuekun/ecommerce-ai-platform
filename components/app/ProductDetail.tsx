...
import type { PRODUCT_BY_SLUG_QUERY_RESULT, VARIANT_SIBLINGS_FULL_QUERY_RESULT } from "@/sanity.types";
...
export function ProductDetail({ product, variants }: ProductDetailProps) {
  ...
  const handleVariantSwitch = useCallback((slug: string) => {
    ...
    <>
      ...
      <div className="mx-auto max-w-[1400px] px-4 py-8 sm:px-6 sm:py-12 lg:px-10 lg:py-14">
        <div className="grid gap-8 lg:grid-cols-[1fr_420px] lg:gap-16 xl:grid-cols-[1fr_460px]">
          ...
          {/* Product Info */}
          <div className="lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-8rem)] lg:overflow-y-auto lg:scrollbar-hide lg:px-1">
            <ProductInfo
