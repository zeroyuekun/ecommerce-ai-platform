...
**Dropdown width**: The mega dropdown width is dynamically constrained to match the span of the navigation links (New to Sale) rather than stretching the full page width. It stays consistent regardless of which category is hovered.
